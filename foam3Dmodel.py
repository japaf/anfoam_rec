...
#load logger
log=logging.getLogger('anfoamRec.foam3Dmodel')
...
class foamModel:
    ...
    def initFromGeoFile(self,geofile):
        v, e, s, vol = geoExtractor.loadGeoFoamFile(geofile)
        self.vertexList = v
        self.edgeList = e
        self.surfaceList = s
        self.volumeList = vol
    ...
    def saveAsGeo(self,filename):
        geoExtractor.writeAsGeo(self.vertexList, self.edgeList, self.surfaceList, self.volumeList, filename)
